...
dataPathTrain = '/Users/litangqing/tensor-conda/oc-nn-master/data/cifar-10_data/train/dogs/'
dataPathTest = '/Users/litangqing/tensor-conda/oc-nn-master/data/cifar-10_data/test/'
...
def func_getKerasModelfeatures():
    ...
    with open('/Users/litangqing/tensor-conda/oc-nn-master/flower-recognition/conf/conf.json') as f:
        config = json.load(f)
...
def init_weights_1(shape):
    """ Weight initialization """
    init_w_1 = np.load("/Users/litangqing/tensor-conda/oc-nn-master/models/weights/inp_hidden.npy")
    return tf.Variable(init_w_1)

def init_weights_2(shape):
    """ Weight initialization """
    init_w_2 = np.load("/Users/litangqing/tensor-conda/oc-nn-master/models/weights/hid_out.npy")
